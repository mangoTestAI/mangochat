...
DATABASE_URL = os.environ.get("DATABASE_URL", f"postgresql://postgres.tokyabyidlwzxyaaxows:Qiaojun%40369@aws-1-ap-southeast-2.pooler.supabase.com:5432/postgres")
