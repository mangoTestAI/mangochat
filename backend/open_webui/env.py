...
WEBUI_NAME = os.environ.get("WEBUI_NAME", "芒果AI")
...
DATABASE_URL = os.environ.get("DATABASE_URL", f"postgresql://postgres.ochxljmbwvlnsnyqcvbn:Qiaojun%40369@aws-1-ap-south-1.pooler.supabase.com:6543/postgres")
